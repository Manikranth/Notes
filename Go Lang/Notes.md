...
Switch statements: Multi-branch selection statements that allow you to execute different blocks of code based on the value of a specified expression or condition. Go automatically breaks after each case, so there is no need for a break statement.
